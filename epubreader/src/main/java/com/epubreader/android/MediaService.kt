...
import com.epubreader.android.utils.LifecycleMediaSessionService
...
@OptIn(ExperimentalMedia2::class, ExperimentalAudiobook::class)
class MediaService(override val lifecycle: Lifecycle) : LifecycleMediaSessionService() {
